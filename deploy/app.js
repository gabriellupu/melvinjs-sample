...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define('melvin',['underscore', 'backbone', 'marionette'], function(_, Backbone, Marionette) {
...
with (obj) {
__p += '<h1 class="page-title">' +
__e( model.title ) +
'</h1><div class="article-author"><span class="profile-picture"><img src="' +
((__t = ( model.author.profilePicture )) == null ? '' : __t) +
'" class="img-circle"/></span><span class="author-name">' +
__e( model.author.name ) +
' on&nbsp;</span><span class="artcile-date"><i>' +
__e( model.date ) +
'</i></span></div><section><div class="row"><div class="col-md-8 col-md-offset-2"><div class="main-picture"><img src="' +
((__t = ( model.image )) == null ? '' : __t) +
'" class="article-image img-thumbnail"/></div></div></div><br/><p>' +
__e( model.paragraph ) +
'</p><!-- ------------ Bio section--><div class="row"><div class="col-md-8 col-md-offset-2"><div class="author-details"><div class="media"><div class="media-left"><a href="http://google.com"><img src="' +
((__t = ( model.author.profilePicture )) == null ? '' : __t) +
'" class="media-object author-picture img-circle"/></a></div><div class="media-body"><h4 class="media-heading">' +
__e( model.author.name ) +
'</h4><p class="author-bio">' +
__e( model.author.bio ) +
'</p></div></div></div></div></div><!-- ------------ Comments section--><div class="row comments-section"><div class="col-md-10 col-md-offset-1"><div class="media"><div class="media-left"><a href="google.com"><img src="' +
((__t = ( model.comments[0].user.profilePicture )) == null ? '' : __t) +
'" class="media-object user-picture img-rounded"/></a></div><div class="media-body"><h4 class="media-heading">' +
__e( model.comments[0].user.name ) +
'</h4><small class="text-muted"><span class="glyphicon glyphicon-time"></span>&nbsp;' +
__e( model.comments[0].date ) +
'</small><p class="user-comment">' +
__e( model.comments[0].comment ) +
'</p><div class="media"><div class="media-left"><a href="google.com"><img src="' +
((__t = ( model.comments[0].reply[0].user.profilePicture )) == null ? '' : __t) +
'" class="media-object user-picture img-rounded"/></a></div><div class="media-body"><h4 class="media-heading">' +
__e( model.comments[0].reply[0].user.name ) +
'</h4><small class="text-muted"><span class="glyphicon glyphicon-time"></span>&nbsp;' +
__e( model.comments[0].reply[0].date ) +
'</small><p class="user-comment">' +
__e( model.comments[0].reply[0].comment ) +
'</p></div></div></div></div><div class="media"><div class="media-left"><a href="google.com"><img src="' +
((__t = ( model.comments[1].user.profilePicture )) == null ? '' : __t) +
'" class="media-object user-picture img-rounded"/></a></div><div class="media-body"><h4 class="media-heading">' +
__e( model.comments[1].user.name ) +
'</h4><small class="text-muted"><span class="glyphicon glyphicon-time"></span>&nbsp;' +
__e( model.comments[1].date ) +
'</small><p class="user-comment">' +
__e( model.comments[1].comment ) +
 ...
 */
define('app',['require','exports','module','melvin'],function(require, exports, module) {
...
define('modules/home/models/article',['require','exports','module','backbone'],function(require, exports, module) {
    var Backbone = require('backbone');
...
define('modules/home/views/layout',['require','exports','module','melvin'],function(require, exports, module) {
    var Melvin = require('melvin');
...
define('modules/home/controllers/route-controller',['require','exports','module','app','../models/article','../views/layout'],function(require, exports, module) {
    var app = require('app');
...
define('modules/home/router',['require','exports','module','marionette','./controllers/route-controller'],function (require, exports, module) {
    var Marionette = require('marionette');
...
define('router',['require','exports','module','marionette','modules/home/router'],function (require, exports, module) {
    var Marionette = require('marionette');
    require('modules/home/router');

    module.exports = Marionette.AppRouter;
});
define('main',['require','exports','module','app','./router'],function(require, exports, module) {
    var app = require('app');
